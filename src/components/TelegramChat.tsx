...
export const TelegramChat = forwardRef<HTMLDivElement, TelegramChatProps>(function TelegramChat(
  ...
  return (
    <div ref={ref} className="telegram-chat">
      ...
      <div ref={feedRef} className="telegram-chat__feed">
        ...
        <div ref={userMessageRef} className="telegram-chat__bubble telegram-chat__bubble--user">
